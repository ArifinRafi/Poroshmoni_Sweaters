        ...
        return (
                <div>
                     ...
                     <div className='lg:mx-24 lg:w-[400px]'>
                        ...
                        <div className='bg-blue-900 lg:w-[200px] shadow-2xl lg:h-[150px] h-[250px] text-white'>
                        <div className='mx-4'> <h1 className='text-2xl flex justify-center pt-4 font-semibold'>20+ </h1 >  Years of Experiences <br /><div className='flex justify-center items-center'>
