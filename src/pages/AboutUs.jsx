        ...
        return (
                <div>
                     ...
                     <div className='lg:mx-24 lg:w-[400px]'>
                        ...
                        <div className='bg-blue-900 flex items-center justify-center lg:m-0 lg:w-[200px] shadow-2xl w-[20rem] h-[250px] text-white'>
                       ...
                       <ul className='flex justify-center lg:w-[190px]'>
                        ...
                        <ul className='flex justify-center lg:ml-0 ml-4 lg:w-[210px]'>
                        ...
                        <ul className='flex justify-center lg:ml-0 ml-5 lg:w-[215px]'>
                        <IoMdCheckmarkCircleOutline className='text-blue-900  w-[30px] h-[20px]' /> <div>Quality Control System</div>
                        </ul>
                        <ul className='flex justify-center lg:ml-0 ml-8 lg:w-[230px]'>
